				...
				<div className="fixed inset-0 flex items-center justify-center z-50">
					<div className="bg-white p-2 sm:p-4 md:p-6 rounded-xl shadow-xl w-[40vw] sm:w-[40vw] md:w-[28vw] lg:w-[25vw]">
						...
						<div className="flex items-center justify-between">
							<button onClick={scrollLeft} className="w-1/12 text-gray-500 hover:text-black">
								◀
							</button>
							...
							<div className="px-1 flex justify-center items-center w-full">
								...
								>
									...
									{!isUnlocked && (
										<div className="text-[1.5vw] sm:text-[1vw] text-red-500 mt-1">Locked</div>
									)}
								</div>
							</div>

							<button onClick={scrollRight} className="w-1/12 text-gray-500 hover:text-black">
								▶
							</button>
						</div>
