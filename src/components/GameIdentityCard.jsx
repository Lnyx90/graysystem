								...
								<img
									...
									onClick={() => {
										if (!achievements.photography) {
											setLockedMessage(
												'Take photos in different locations to unlock this achievement.'
											);
								...
								<h3
									className={`text-sm mt-1 ${
										!achievements.photography
											? 'text-[8px] md:text-sm lg:text-base text-gray-400'
											: ''
									}`}
								>
									Photography
							...
							<div className="w-12 md:w-24 flex flex-col items-center mx-auto">
								...
								<h3
									className={`text-sm mt-1 whitespace-nowrap ${
										!achievements.explorer ? 'text-[8px] md:text-sm lg:text-base text-gray-400' : ''
									}`}
								>
									Map Explorer
								</h3>
								...
								<img
									...
									onClick={() => {
										if (!achievements.campSkills) {
											setLockedMessage(
												'Complete camp tasks like cooking, hiking and enjoying the view at the Mountain to earn this achievement.'
											);
											setShowLockedPopup(true);
										}
									}}
