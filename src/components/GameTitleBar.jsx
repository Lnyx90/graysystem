...
function GameTitleBar({ formattedDate, unlockedItems, unlockItem, achievements, level, exp }) {
	...
	return (
		<>
			...
			>
				<span className="text-[9px] md:text-sm lg:text-base">Archipelago Adventure</span>

				<div className="flex md:mx-10 gap-2">
					<button onClick={() => setShowCard(true)} className="text-[9px] md:text-sm lg:text-base">
						Level <span>1</span>
					</button>
				...
				<div className="flex items-center">
					<img src="images/symbol/calendar.png" className="w-5 md:w-10 lg:w-20" />
					<span className="text-[9px] md:text-sm lg:text-base">{formattedDate}</span>
				</div>
			</div>
