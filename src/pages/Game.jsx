...
function Game() {
	...
	const [holeOpacity, setHoleOpacity] = useState(1); // 1 = fully visible, 0 = invisible
...
useEffect(() => {
	...
	setIsDead(true);
	setShowHole(true); // Show hole when player dies
	setIsSinking(true); // Start sinking animation
						...
						>
							{showHole && (
								<img
									...
									alt="hole"
									onAnimationEnd={() => {
									// Pastikan state sync setelah animasi selesai
